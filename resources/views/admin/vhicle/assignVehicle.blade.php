...
@section('admin')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Vehicle Assign</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h5>Vehicle List</h5>
                    <button class="btn btn-primary fa-pull-right btn-sm" data-toggle="modal" data-target="#assignnewvcahile">Assign New Vehicle</button>
                </div>
    ...
    <div class="modal fade" id="assignnewvcahile" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
