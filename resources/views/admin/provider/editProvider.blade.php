            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Update Provider</h5>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form action="{{route('admin.provider.update')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 fill">
                                        <label for="exampleInputEmail1">Provider Full Name</label>
                                        <input type="text" name="name" value="{{$users->name}}" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                        <input type="hidden" name="provider_edit_id" value="{{$users->id}}"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                    </div>

                                    <div class="form-group col-md-6 fill">
                                        <label for="exampleInputEmail1">Provider Email</label>
                                        <input type="email" name="email" value="{{$users->email}}"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                    </div>

                                    <div class="form-group col-md-6 fill">
                                        <label for="exampleInputEmail1">Provider Mobile No.</label>
                                    ...
                                    <div class="form-group col-md-12 fill">
                                        <label for="exampleInputEmail1">Provider Address</label>
