...
@section('admin')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h5>Category List</h5>
                    <button class="btn btn-primary fa-pull-right btn-sm" data-toggle="modal" data-target="#createncat">Create New Category</button>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped" id="users">
                            ...
                            @foreach($all_cats as $cat)
                                <tr>
                                    <td>
                                        ...
                                        @elseif($cat->category_type == 2)
                                            Truck
                                        @elseif($cat->category_type == 3)
                                            Restaurant
                                        @elseif($cat->category_type == 4)
                                            Multivendor
                                        @elseif($cat->category_type == 5)
                                            Machinery
                                        @else
                                            Not Set
                                        @endif
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#adminallcatedit{{$cat->id}}"><i class="fa fa-edit"></i> </button>
                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#adminallcatdelete{{$cat->id}}"><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>



                                <div class="modal fade" id="adminallcatdelete{{$cat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal fade" id="adminallcatedit{{$cat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="category_type">
                                                            ...
                                                            <option value="1" {{$cat->category_type == 1 ? 'selected' : ''}}>Taxi</option>
                                                            <option value="2" {{$cat->category_type == 2 ? 'selected' : ''}}>Truck</option>
                                                            <option value="3" {{$cat->category_type == 3 ? 'selected' : ''}}>Restaurant</option>
                                                            <option value="4" {{$cat->category_type == 4 ? 'selected' : ''}}>Multivendor</option>
                                                            <option value="5" {{$cat->category_type == 5 ? 'selected' : ''}}>Machinery</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Category Name</label>
                                                        <input type="text" class="form-control" name="category_name" value="{{$cat->category_name}}" placeholder="Enter Category Name">
                                                        <input type="hidden" class="form-control" name="category_edit_id" value="{{$cat->id}}" placeholder="Enter Category Name">
                                                    </div>
                                                    <div class="form-group">
    ...
    <div class="modal fade" id="createncat" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_type">
                                ...
                                <option value="4">Multivendor</option>
