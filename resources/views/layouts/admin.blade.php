    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div " >
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.general.settings')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">General Settings</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                    <label>User Management</label>
                </li>
                <li class="nav-item">
                    <a href="{{route('admin.create.user')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Create User</span></a>
                </li>
                <li class="nav-item">
