    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div " >
            ...
            <div class="">
                ...
                <div class="collapse" id="nav-user-link">
                    <ul class="list-unstyled">
                        ...
                        <li class="list-group-item"><a href="{{route('multivendorstore.logout')}}"><i class="feather icon-log-out m-r-5"></i>Logout</a></li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('multivendorstore.dashboard')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{route('multivendor.store.category')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Category Management</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                ...
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        ...
                        <ul class="pro-body">
                            ...
                            <li><a href="{{route('multivendorstore.logout')}}" class="dropdown-item"><i class="feather icon-lock"></i> Log Out</a></li>
                        </ul>
                    </div>
                </div>
            </li>
