    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div " >
            ...
            <div class="">
                ...
                <div class="collapse" id="nav-user-link">
                    <ul class="list-unstyled">
                        ...
                        <li class="list-group-item"><a href="{{route('provider.logout')}}"><i class="feather icon-log-out m-r-5"></i>Logout</a></li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('provider.dashboard')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{route('provider.category')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Taxi Category</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                    <label>Product Management</label>
                </li>
                <li class="nav-item">
                    <a href="{{route('taxi.management')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Taxi Management</span></a>
                </li>
                ...
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        ...
                        <ul class="pro-body">
                            ...
                            <li><a href="{{route('provider.logout')}}" class="dropdown-item"><i class="feather icon-lock"></i> Log Out</a></li>
                        </ul>
                    </div>
                </div>
            </li>
