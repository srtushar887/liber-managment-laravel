...
{{--                <li class="nav-item">--}}
{{--                    <a href="{{route('provider.category')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Category Management</span></a>--}}
{{--                </li>--}}
                <li class="nav-item pcoded-menu-caption">
