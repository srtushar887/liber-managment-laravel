...
class AdminProviderController extends Controller
{
    ...
    {
        $new_provider = new Provider_account();
    ...
    {
        $delete_provider = Provider_account::where('id',$request->provider_delete_id)->first();
    ...
    public function password_change_provider(Request $request)
    {
        ...
        if ($npass != $cpass){
            ...
            $user = Provider_account::where('id',$request->provider_password_id)->first();
